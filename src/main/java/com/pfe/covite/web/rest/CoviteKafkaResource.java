...
@RestController
@RequestMapping("/api/covite-kafka")
public class CoviteKafkaResource {

    private final Logger log = LoggerFactory.getLogger(CoviteKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public CoviteKafkaResource(KafkaProperties kafkaProperties) {
